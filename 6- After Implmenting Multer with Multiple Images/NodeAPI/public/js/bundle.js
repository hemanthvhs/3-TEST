...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVtYW50aHZocyIsImEiOiJja3IzMzQxcDMxZGR5MnNyeHE4bTJ2ZDNlIn0.cnOllD6-8ZUrZYeDdUfNkA';
  var map = new mapboxgl.Map({
    container: 'map',
    // 'map' means the mapbox inserts map into the html whose element has id map
    style: 'mapbox://styles/hemanthvhs/ckr37t74fecc218o08uxz4jqo',
    scrollZoom: false // The reason why below center is commented is because we have got the various locations & based on these locations we want to center the map
    // center: [-118.113491, 34.111745], // starting position [lng, lat]
    // zoom: 10,
    // interactive: false,

  });
  var bounds = new mapboxgl.LngLatBounds(); // Adding marker which is custom css pin on the each locations
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // 2) Add the marker to each location coordinates
...
var userSettingsFormEl = document.querySelector('.form-user-settings');
...
if (userDataFormEl) {
  userDataFormEl.addEventListener('submit', function (e) {
    e.preventDefault(); // SINCE WE WANT TO UPLOAD THE USER PHOTO IN THE DB, WE NEED TO SEDN THAT TO API AS MULTIPART/FORMDATA
...
if (userSettingsFormEl) {
  userSettingsFormEl.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var savePasswordBtnEl, currentPassword, newPassword, confirmPassword;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              savePasswordBtnEl = document.querySelector('.btn--save-password');
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
